...
class FindObjects:
    ...
    def find_objects(self, image, debug=False):
        ...
        if debug: cv2.imshow("background", background_img)
        ...
        if debug: cv2.imshow("img", original_img)
        ...
        if debug: cv2.imshow("thr", thresholded_img)
        ...
        if debug: cv2.imshow("morph", thresholded_img)
