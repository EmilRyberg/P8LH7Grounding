...
class SpatialModuleOneOfEach(unittest.TestCase):
    ...
    def test_above(self):
        ...
        actual_indices, success_enum = self.spatial.locate_specific_object(object_entity, self.objects)
...
class SpatialModuleTwoOfEach(unittest.TestCase):
    ...
    def test_twoOfReference(self):
        ...
        task = self.cmd_builder.get_task("Dummy sentence")
        object_entity = task.objects_to_execute_on[0]
        actual_indices, status = self.spatial.locate_specific_object(object_entity, self.objects)
    ...
    def test_locate_specific_object__relative_to_object_at_static_location__returns_closest_object(self):
        object_entity = ObjectEntity(name="blue cover")
        spatial_description = SpatialDescription(spatial_type=SpatialType.BELOW)
    ...
    def test_get_location__static_location__returns_static_location(self):
        ...
        locations, status = self.spatial.get_location(spatial_descriptions, self.objects)
        x, y = locations[0]
    ...
    def test_get_location__object_at_static_location__returns_error(self):
        ...
        locations, status = self.spatial.get_location(spatial_descriptions, objects)
